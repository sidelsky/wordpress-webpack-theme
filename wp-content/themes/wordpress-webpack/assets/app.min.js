...
var _magicLine = __webpack_require__(10);

var _magicLine2 = _interopRequireDefault(_magicLine);

var _remodal = __webpack_require__(11);
...
var videoPlayer = document.querySelector(".js-video-player"); /* global require */
/* global window */
/* global site_data */
/* jshint -W097 */
...
exports.init_magic_line = init_magic_line;
...
function magic_line() {
   ...
   var $el, leftPos, newWidth, padding;
   ...
   */
   ...
   $magicLine.width($currentItem.width()).css("left", $currentItem.position().left + padding).data("origLeft", $magicLine.position().left).data("origWidth", $magicLine.width());
...
(function () {
   var subNavigation, navigation, pageWrap, navigationHeight, subNavigationHeight, navWrapper, navWrapperHeight, stickyTop;
...
})(jQuery); // import ResponsiveLazyLoader from 'responsive-lazy-loader';
